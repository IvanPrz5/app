                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field label="Simbolo"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
  ...
  export default {
    ...
    data: () => ({
      headers: [
        ...
        { text: "Nombre", value: "fisica", sortable: false },
        { text: "Descripcion", value: "descripcion", sortable: false },
        { text: "Simbolo", value: "moral", sortable: false },
        ...
        axios
          ...
          .then((response) => {
            ...
            for (let i = 0; i < response.data.length; i++) {
              this.desserts.push({
                clave: response.data[i].cclaveUnidad,
                descripcion: response.data[i].descripcion,
                fisica: response.data[i].nombre,
                moral: response.data[i].simbolo,
