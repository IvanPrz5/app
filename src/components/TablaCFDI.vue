                  ...
                  <v-card-text>
                    <v-container>
                      <v-row>
                        ...
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field label="Fisica"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field label="Moral"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
                          <v-text-field label="Regimen Fiscal"></v-text-field>
                        </v-col>
                        <v-col cols="12" sm="6" md="4">
  ...
  export default {
    ...
    data: () => ({
      headers: [
        ...
        { text: "Fisica", value: "fisica", sortable: false },
        { text: "Moral", value: "moral", sortable: false },
        { text: "Regimen Fiscal Receptor", value: "regimen", sortable: false },
        ...
        axios
          ...
          .then((response) => {
            ...
            for (let i = 0; i < response.data.length; i++) {
              this.desserts.push({
                clave: response.data[i].cusoCFDI,
